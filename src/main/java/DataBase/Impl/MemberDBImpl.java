...
public class MemberDBImpl implements MemberDB {
    ...
    public LoginMember getRegisteredLoginMember(LoginMember loginMember){
    ...
    public void removeMemberEntityByID(String id){
    ...
    public boolean isDeleteMemberValid(DeleteMember deleteMember){
        for(MemberEntity memberEntity : memberEntities){
